...
def define_arguments(parser):
    parser.add_argument("--model", type=str, default='gam', choices=['gam'])
    parser.add_argument("--dataset", type=str, default='KAIROS', choices=['ACE', 'wikievents','rams'])
    ...
    parser.add_argument("--lambda1", type=float, default=1, help="inputs = inputs + node_embedding * lambda1")
    parser.add_argument("--alpha", type=float, default=1)
    parser.add_argument("--beta", type=float, default=1)
    parser.add_argument("--m3", type=float, default=1)
def parse_arguments():
